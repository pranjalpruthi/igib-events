...
export const CreepyButton = ({
    ...
    return (
        ...
        >
            ...
            <motion.span
                ref={eyesRef}
                className="absolute flex items-center gap-[0.375em] right-[1.5em] bottom-[0.8em] h-[0.75em] z-0 pointer-events-none"
            ...
            <motion.span
                className={cn(
                    "absolute inset-0 block rounded-xl bg-amber-500 text-white font-bold tracking-wider",
            ...
            <span className="flex items-center justify-center opacity-0 px-6 sm:px-8 py-2 font-bold tracking-wider min-w-[9em]">
                {children}
            </span>
        </button>
    );
