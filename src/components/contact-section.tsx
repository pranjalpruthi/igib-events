        ...
        <footer className="border-t bg-background py-8 pb-24 lg:pb-12">
            <div className="mx-auto max-w-7xl px-6 lg:px-12">
                <div className="flex flex-col gap-6">
                    ...
                    {/* Social Links - Separate row on mobile */}
                    <div className="flex items-center justify-center gap-4">
                        <a href="https://github.com/BioinformaticsOnLine" target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary inline-flex items-center gap-1.5 text-sm">
                        ...
                        <a href="https://facebook.com/bioinformaticsonline" target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary inline-flex items-center gap-1.5 text-sm">
                        ...
                        <a href="https://discord.gg/bz2EKz9nG" target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary inline-flex items-center gap-1.5 text-sm">
