...
const scheduleData: DaySchedule[] = [
    {
        ...
        sessions: [
            ...
            { time: '09:30 - 10:00', icon: Users, title: 'Workshop 2: Inauguration & Welcome Address', speaker: 'Dr. Souvik Maiti (honourable Director CSIR-IGIB)', description: 'Overview of the One Health approach and our goals for this workshop', type: 'admin' },
            { time: '10:00 - 10:20', icon: Users, title: 'Photo Session', type: 'admin' },
            { time: '10:20 - 11:00', icon: Users, title: 'Workshop 2: Delegates Introduction', speaker: 'Dr. Jitendra', type: 'admin' },
    ...
    },
    {
        ...
        sessions: [
            ...
            { time: '10:15 - 11:15', icon: GraduationCap, title: 'Talk 2: Reconstructing the Genome', speaker: 'Dr. Jitendra Narayan', type: 'lecture' },
            { time: '11:15 - 11:45', icon: Coffee, title: 'Tea Break', type: 'break' },
            { time: '11:45 - 12:15', icon: GraduationCap, title: 'Talk 3', speaker: 'Dr. Bhupesh Taneja', type: 'lecture' },
            { time: '12:15 - 13:00', icon: Laptop, title: 'Hands-on Session 2A: Genome Assembly Workflow', speaker: 'Mukul', description: '• Running FastQC on raw sequencing data (Quality assessment) • Quality Assessment and visualization • Generating MultiQC reports', tools: 'FastQC, Fastp, MultiQC', type: 'handson' },
            { time: '13:00 - 14:00', icon: Utensils, title: 'Lunch Break', type: 'meal' },
            ...
            { time: '16:00 - 18:00', icon: Laptop, title: 'Hands-on Session 2B(ii): Assembly Quality Assessment : Completeness and Contamination Check Scaffolding', speaker: 'Mukul', description: '• QUAST for assembled contig quality metrics • Assessing completeness and contamination • Contig Scaffolding with Ragtag', tools: 'Quast, BUSCO and Ragtag', type: 'handson' },
            { time: '20:00 - 21:00', icon: Utensils, title: 'Dinner', type: 'meal' },
        ]
    },
    {
        ...
        sessions: [
            ...
            { time: '11:15 - 11:45', icon: Coffee, title: 'Tea Break', type: 'break' },
            { time: '11:45 - 13:00', icon: Laptop, title: 'Hands-on Session 3A: SNP & Variant Calling', speaker: 'Nityendra / Anwesha', description: '• Mapping Reads to Reference genomes • Variant Calling and filtering • Identifying important mutations for pathogen characterization', tools: 'minimap2, Samtools, bcftools', type: 'handson' },
            { time: '13:00 - 14:00', icon: Utensils, title: 'Lunch Break', type: 'meal' },
            { time: '14:00 - 14:30', icon: Laptop, title: 'Hands-on Session 3B(i) : Sequence Alignment & Phylogenetic tree Construction', speaker: 'Mukul', description: '• Multiple Sequence Alignment (MSA) with MUSCLE/MAFFT • Building maximum likelihood tree with RAxML/IQtree • Tree Visualization and annotation', tools: 'MUSCLE/ MAFFT and RAxML/IQtree', type: 'handson' },
            { time: '14:30 - 15:30', icon: Laptop, title: 'Hands-on Session 3B(ii) : Phylogenetic Tree Construction continued & other Genomic analysis', speaker: 'Ajay', description: '• Pathway Enrichment Analysis with getEnrich • Chromosomal rearrangement analysis with Chitra tool', type: 'handson' },
            { time: '15:30 - 16:00', icon: Coffee, title: 'Tea Break', type: 'break' },
            { time: '16:00 - 18:00', icon: Laptop, title: 'Hands-on Session 3C: SSR Analysis and a Comparative tool overview: Crossroads', speaker: 'Preeti', type: 'handson' },
            { time: '20:00 - 21:00', icon: Utensils, title: 'Dinner', type: 'meal' },
        ]
    },
    {
        ...
        sessions: [
            { time: '09:00 - 10:00', icon: Utensils, title: 'Breakfast', type: 'meal' },
            { time: '10:00 - 10:15', icon: Users, title: 'Overview of the Day', type: 'admin' },
            { time: '10:15 - 11:15', icon: GraduationCap, title: 'Talk 5', speaker: 'Dr. Anshu Bhardwaj', type: 'lecture' },
            { time: '11:15 - 11:45', icon: Coffee, title: 'Tea Break', type: 'break' },
            { time: '11:45 - 12:15', icon: Laptop, title: 'Hands-on Session 4A', type: 'handson' },
            { time: '12:15 - 13:00', icon: Laptop, title: 'Hands-on Session 4B(i): Antimicrobial Resistance: A Genomic Perspective', speaker: 'Anwesha', description: '• Exploring CARD and ResFinder databases • Identifying known resistance genes in assembled genomes • Understanding resistance gene nomenclature and classification', tools: 'CARD, ResFinder, AMRfinder', type: 'handson' },
            { time: '13:00 - 14:00', icon: Utensils, title: 'Lunch Break', type: 'meal' },
            { time: '14:00 - 16:00', icon: Laptop, title: 'Hands-on Session 4B(ii): AMR Resistance Pattern Analysis', speaker: 'Anwesha', description: '• Detecting plasmid-mediated resistance • Analyzing resistance hotspots in genomes • Creating resistance Profiles for epidemiological tracking • Predicting antibiotic susceptibility from genomic data • Building prediction models for common pathogens • Interpreting clinical breakpoints', tools: 'Genoptypic & phenotypic correlation tools', type: 'handson' },
            { time: '16:00 - 16:30', icon: Coffee, title: 'Tea Break', type: 'break' },
            { time: '16:30 - 18:00', icon: Laptop, title: 'Hands-on Session 4C: AI-Powered Resistance Prediction', speaker: 'BT LAB', description: '• Understanding prediction models and confidence • Identifying novel/emerging resistance patterns before widespread characterization • Running predictions on real pathogen isolates', tools: 'SPARA, Marker-ML', type: 'handson' },
    ...
    },
    {
        ...
        sessions: [
            { time: '09:00 - 10:00', icon: Utensils, title: 'Breakfast', type: 'meal' },
            { time: '10:00 - 10:15', icon: Users, title: 'Overview of the Day', type: 'admin' },
            { time: '10:15 - 11:15', icon: GraduationCap, title: 'Talk 6', speaker: 'Dr. Kumardeep Chaudhary', type: 'lecture' },
            { time: '11:15 - 11:45', icon: Coffee, title: 'Tea Break', type: 'break' },
            { time: '11:45 - 12:45', icon: GraduationCap, title: 'Talk 7', speaker: 'Rajesh Pandey', type: 'lecture' },
            ...
            { time: '14:30 - 18:00', icon: Users, title: 'Delhi Darshan: Amrit Udyan, India Gate and War Memorial Visit', type: 'tour' }
        ]
    },
]
